# Generated by Django 3.2.7 on 2021-11-05 14:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='serials.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='serials.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Product Specifiations',
            },
        ),
        migrations.CreateModel(
            name='ProductType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='serials.product')),
                ('specification', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='serials.productspecification')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='product_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='serials.producttype'),
        ),
        migrations.CreateModel(
            name='ProductImage',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_image', to='serials.product')),
            ],
            options={
                'verbose_name': 'Plural Image',
